//
//  HomeProfileFirstImageView.swift
//  OurDday
//
...
class HomeProfileFirstImageView: UIImageView {
...
extension HomeProfileFirstImageView: UIContextMenuInteractionDelegate {
